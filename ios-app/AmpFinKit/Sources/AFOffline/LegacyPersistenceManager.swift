...
private struct LegacyPersistenceManager {
    ...
    private init() {
        ...
        let modelConfiguration = ModelConfiguration("AmpFin", schema: schema, isStoredInMemoryOnly: false, allowsSave: true, groupContainer: AFKIT_ENABLE_ALL_FEATURES ? .identifier(AFKIT_APP_GROUP) : .none)
...
private extension LegacyPersistenceManager {
    ...
    final class OfflineTrack {
        ...
        var album: Track.ReducedAlbum
        var artists: [Item.ReducedArtist]
