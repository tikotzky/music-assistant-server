...
/// Decodes a JSON value that may be either a string or a number into a String.
internal struct FlexID: Decodable, CustomStringConvertible {
    let value: String
...
internal struct OptionalFlexID: Decodable {
    let value: String?
...
internal struct TFSContent: Decodable {
    ...
    let is_favorite: Bool?
    let artists: [TFSArtist]?
    let collection_id: OptionalFlexID?
