    ...
    var nowPlaying: Track? {
        didSet {
            ...
            if let nowPlaying = nowPlaying {
                playbackReporter = PlaybackReporter(trackId: nowPlaying.id, playSessionId: TwentyFourSixClient.sessionID(itemId: nowPlaying.id, bitrate: maxBitrate), queue: queue)
    ...
    var maxBitrate: Int? {
        didSet {
            ...
            if playbackReporter != nil, let nowPlaying {
                playbackReporter?.playSessionId = TwentyFourSixClient.sessionID(itemId: nowPlaying.id, bitrate: maxBitrate)
            }
